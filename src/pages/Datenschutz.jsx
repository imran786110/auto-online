...
const Datenschutz = () => {
  return (
    <Box p={8} maxW="800px" mx="auto" id='datenschutz'>
      <Heading mb={4}>Datenschutz</Heading>

      <Box mb={6}>
        <Heading as="h2" fontSize="xl" mb={2}>
        Datenschutzerklärung
        </Heading>
        <Text mt={4}>Diese Datenschutzerklärung klärt Sie über die Art, den Umfang und Zweck der Verarbeitung von personenbezogenen Daten (nachfolgend kurz „Daten“) innerhalb unseres Onlineangebotes und der mit ihm verbundenen Webseiten, Funktionen und Inhalte sowie externen Onlinepräsenzen, wie z.B. unser Social Media Profile auf (nachfolgend gemeinsam bezeichnet als „Onlineangebot“). Im Hinblick auf die verwendeten Begrifflichkeiten, wie z.B. „Verarbeitung“ oder „Verantwortlicher“ verweisen wir auf die Definitionen im Art. 4 der Datenschutzgrundverordnung (DSGVO).</Text>
      </Box>
      ...
      <Box mb={6}>
        ...
        <UnorderedList>
          ...
          <ListItem>Inhaltsdaten (z.B., Texteingaben, Fotografien, Videos)</ListItem>
          <ListItem>Nutzungsdaten (z.B., besuchte Webseiten, Interesse an Inhalten, Zugriffszeiten)</ListItem>
      ...
      <Box mb={6}>
        ...
        <Text>Besucher und Nutzer des Onlineangebotes („Nutzer“)</Text>
      </Box>
      ...
      <Box mb={6}>
        ...
        <UnorderedList>
          <ListItem>Zur Verfügungstellung des Onlineangebotes, seiner Funktionen und Inhalte.</ListItem>
          <ListItem>Beantwortung von Kontaktanfragen und Kommunikation mit Nutzern.</ListItem>
          <ListItem>Sicherheitsmaßnahmen.</ListItem>
          <ListItem>Reichweitenmessung/Marketing.</ListItem>
        </UnorderedList>
      </Box>
...
Ein genereller Widerspruch gegen den Einsatz der zu Zwecken des Onlinemarketing eingesetzten Cookies kann bei einer Vielzahl der Dienste, vor allem im Fall des Trackings, über die US-amerikanische <br/> Seite <Link color="blue" href='https://web.archive.org/web/20201205024324/http://www.aboutads.info/choices/'>http://www.aboutads.info/choices/ </Link> oder die EU-Seite <Link color="blue" href='https://web.archive.org/web/20201205024324/http://www.youronlinechoices.com/'>http://www.youronlinechoices.com/</Link> erklärt werden. Des Weiteren kann die Speicherung von Cookies mittels deren Abschaltung in den Einstellungen des Browsers erreicht werden. Bitte beachten Sie, dass dann gegebenenfalls nicht alle Funktionen dieses Onlineangebotes genutzt werden können.
        </Text>
      </Box>
